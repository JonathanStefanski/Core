...
namespace Core.API.Controllers
{
    ...
    {        
        ...
        public async Task<IActionResult> GetMessage(int userId, int id)
        {
            ...
            var messageToReturnDto = _mapper.Map<MessageDetailDto>(messageFromRepo);
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            var messages = _mapper.Map<IEnumerable<MessageDetailDto>>(messageFromRepo);
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId)
        {
            ...
            var messageThread = _mapper.Map<IEnumerable<MessageDetailDto>>(messagesFromRepo);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageCreationDto messageCreationDto)
        {
            ...
            var recipient = await _repo.GetUser(messageCreationDto.RecipientId);
            ...
            if (await _repo.SaveAll()) {
                var messageToReturn = _mapper.Map<MessageDetailDto>(message);
